defmodule FamilyFoundationsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: FamilyFoundationsWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FamilyFoundationsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FamilyFoundationsWeb.Gettext, "errors", msg, opts)
    end
  end
